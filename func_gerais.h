...
char verificarDestino(const char destino[]);//checa se o destino existe no arquivo destino.txt
...
void imprimirHistorico(Pilha *historico); //Imprime o arquivo de histórico
void removerHistorico(Pilha *historico);//Remove o histórico
void adicionarHistorico(Pilha *historico);//Põe no historico
